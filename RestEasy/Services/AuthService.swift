...
final class AuthService: ObservableObject {
    ...
    /// Maps Firebase auth failures to clear, user-facing messages.
    /// - Parameter error: The error returned by Firebase Auth.
    /// - Returns: A short message suitable for alerts and inline form feedback.
